...
namespace ApiConcessionaria.Infra.Data.Migrations
{
    ...
    [Migration("20251104142853_inclusão-da-lista-opcionais")]
    partial class inclusãodalistaopcionais
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiConcessionaria.Infra.Data.Entities.PedidoOpcional", b =>
                {
                    b.Property<Guid>("IdPedido")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("IdPedido", "IdOpcional");

                    b.HasIndex("IdOpcional");

                    b.ToTable("PEDIDO_OPCIONAL", (string)null);
                });
            ...
            modelBuilder.Entity("ApiConcessionaria.Infra.Data.Entities.Opcional", b =>
                {
                    b.HasOne("ApiConcessionaria.Infra.Data.Entities.Veiculo", "Veiculo")
                        .WithMany("Opcionais")
            ...
            modelBuilder.Entity("ApiConcessionaria.Infra.Data.Entities.PedidoOpcional", b =>
                {
                    b.HasOne("ApiConcessionaria.Infra.Data.Entities.Opcional", "Opcional")
                        .WithMany("PedidoOpcionais")
                        .HasForeignKey("IdOpcional")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApiConcessionaria.Infra.Data.Entities.Pedido", "Pedido")
                        .WithMany("PedidoOpcionais")
